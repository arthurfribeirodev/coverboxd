...
class Users(Base):
    ...
    def _init__(self, username, email, senha, pfp):
...
class Covers(Base):
    ...
    def _init__(self, name, description, image_url, genre_id, date):
        self.name = name
        self.description = description
...
class Artists(Base):
    ...
    def _init__(self, name, description, image_url, genre_id):
        self.name = name
        self.description = description
        self.image_url = image_url
        self.genre_id = genre_id
...
class Rates(Base):
    ...
    def _init__(self, user_id, cover_id, artist_id, rating):
